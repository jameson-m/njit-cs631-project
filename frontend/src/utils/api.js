...
export const fetchDepartments = async url => {
  const result = await axios({
    ...
    url: `http://ec2-18-224-40-4.us-east-2.compute.amazonaws.com:4444${url}`,
    headers: {
...
export const fetchSectionsStudent = async (studentId, courseNumber) => {
  const result = await axios({
    method: 'POST',
    // baseUrl: 'localhost:4444',
    url: 'http://ec2-18-224-40-4.us-east-2.compute.amazonaws.com:4444/student',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    },
...
export const getClassList = async (courseNumber, sectionNumber) => {
  const result = await axios({
    method: 'POST',
    // baseUrl: 'localhost:4444',
    url: 'http://ec2-18-224-40-4.us-east-2.compute.amazonaws.com:4444/faculty',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    },
